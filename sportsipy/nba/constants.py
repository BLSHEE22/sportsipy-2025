...
PLAYER_SCHEME = {
    ...
    'name': 'h1',
    'team_abbreviation': '#meta div p strong',
    'position': '#meta div p span',
    'height': '#meta div p span',
    'weight': '#meta div p span',
    'birth_date': '#meta div p span',
    'nationality': '#meta div p span',
    'age': 'nobr',
    'games_played': '[class="p1"] div',
